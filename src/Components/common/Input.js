...
const StyledDiv = tw.div`relative my-2 w-full`;

const StyledInput = tw.input`block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-white rounded-lg border border-rose-400 appearance-none 
